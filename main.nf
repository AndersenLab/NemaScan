...
if(params.debug) {
    ...
    vcf_file = Channel.fromPath("gs://elegansvariation.org/release/${params.vcf}/variation/WI.${params.vcf}.small.hard-filter.isotype.vcf.gz")
    vcf_index = Channel.fromPath("gs://elegansvariation.org/release/${params.vcf}/variation/WI.${params.vcf}.small.hard-filter.isotype.vcf.gz.tbi")
    ...
    impute_vcf = Channel.fromPath("gs://elegansvariation.org/release/${params.vcf}/variation/WI.${params.vcf}.impute.isotype.vcf.gz")
    impute_vcf_index = Channel.fromPath("gs://elegansvariation.org/release/${params.vcf}/variation/WI.${params.vcf}.impute.isotype.vcf.gz.tbi")
    ...
    ann_file = Channel.fromPath("gs://elegansvariation.org/release/${params.vcf}/variation/WI.${params.vcf}.strain-annotation.tsv")
