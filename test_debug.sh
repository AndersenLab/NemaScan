...
#SBATCH -n 4
#SBATCH --mem=16G               
#SBATCH -o nemascan2.test.slurm.txt
...
# sbatch test_template.sh '--vcf 20220216 --traitfile ../input_data/c_elegans/phenotypes/test_pheno.tsv --out test_mapping_elegans_nomediate --mediation false -resume -N 2088410137@vtext.com'
...
# sbatch test_template.sh '--vcf 20220216 --strains ../input_data/c_elegans/phenotypes/strain_file.tsv -profile genomatrix --out test_genomatrix_elegans -N 2088410137@vtext.com'

# step 2: test using own VCF
# sbatch test_template.sh '--vcf /projects/b1059/data/c_elegans/WI/variation/20220216/vcf/WI.20220216.small.hard-filter.isotype.vcf.gz --traitfile ../input_data/c_elegans/phenotypes/test_pheno.tsv --out test_userVCF -N 2088410137@vtext.com'
...
# sbatch test_template.sh '--vcf 20220216 -profile simulations --out test_simulations_elegans --simulate_nqtl ../input_data/all_species/simulate_nqtl.csv \
...
# sbatch test_template.sh '--vcf 20210901 --traitfile ../input_data/c_tropicalis/phenotypes/test_pheno.tsv --out test_mapping_tropicalis --sthresh EIGEN --species c_tropicalis -N 2088410137@vtext.com'

# step 6: test c_briggsae mapping - not ready yet
# sbatch test_template.sh '--vcf 20210803 --traitfile ../input_data/c_briggsae/phenotypes/test_pheno.tsv --out test_mapping_briggsae --species c_briggsae --sthresh EIGEN'
