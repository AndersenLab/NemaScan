...
# step 2: test c_elegans mapping profile no mediation
...
# step 3: test c_elegans mapping profile no finemap
...
# step 4: test c_elegans genomatrix pofile
...
# step 6: test c_elegans simulations profile
...
# step 9: test giving the wrong vcf 
...
# step 11: test download vcf from cendr
...
# step 12: make sure the mito qtl works
...
# step 13: test c_tropicalis mapping
...
# step 14: test c_briggsae mapping - not ready yet
sbatch test_template.sh 'test_mapping_briggsae' '--vcf 20210803 --traitfile ../../input_data/c_briggsae/phenotypes/test_pheno.tsv --out test_mapping_briggsae --species c_briggsae --sthresh EIGEN -N kathrynevans2015@u.northwestern.edu'
