...
1. [R-data.table](https://cran.r-project.org/web/packages/data.table/index.html)
1. [R-GenomicRanges](https://bioconductor.org/packages/release/bioc/html/GenomicRanges.html)
