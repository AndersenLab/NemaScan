...
#           "pr_Albendazole_mean.TOF.tsv",
#           "Albendazole_mean.EXT_lmm-exact_inbred.fastGWA",
#           "total_independent_tests.txt",
#           1000, # formerly args[7], now args[5]
#           150, # formerly args[8], now args[6]
#           "BF", # formerly args[11], now args[7]
#           "LMM_EXACT_INBRED" #formerly args[15], now args[8]
# )
# FOR QUEST
# load arguments
...
readr::write_tsv(processed_mapping,
                 ...
                 # file =glue::glue("processed_{args[8]}_mapping.tsv"),
                 col_names = T)
...
readr::write_tsv(qtl_region, 
                 ...
                 # file = glue::glue("{args[8]}_qtl_region.tsv"),
                 col_names = T)
