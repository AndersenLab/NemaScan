...
print(glue::glue("Mediation was not performed for {species}"))
...
ref_alt_div %>%
  ...
  geom_vline(xintercept = round(QTL_Peak, digits = -3), linetype = "dashed", size = 2) +
...
p1 <- ggplot2::ggplot(filter(plot_df),
    ...
    ggplot2::geom_vline(xintercept = QTL_Peak, size = 2) +
