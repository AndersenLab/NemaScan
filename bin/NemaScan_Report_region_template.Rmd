...
gene_df <- genes_in_region %>%
    ...
    dplyr::distinct(WBGeneID, PEAK_MARKER, CHROM, STRAND, TRANSCRIPTION_START_POS, 
...
test %>%
    ggplot2::ggplot(.) +
    aes(x = pos, y = strain, fill = div) +
    geom_tile() +
    theme_bw() +
    theme(axis.text.y = element_blank(),
          axis.ticks.y = element_blank(),
          panel.grid = element_blank()) +
    scale_fill_manual(values = c("1" = "indianred1","0" = "grey90","-1" = "dodgerblue3"), 
