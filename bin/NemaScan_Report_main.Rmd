...
For some traits, LOCO might provide more power to detect true QTL because it ignores genomic structure on the chromosome of the main QTL, allowing for higher power to detect linked QTL or QTL within divergent regions. However, this higher power also comes with higher false positive rates. For more info, check out this paper. XXX (more here)
