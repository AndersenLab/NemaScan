...
#SBATCH --time=4:00:00 ## Required: How long will the job need to run (remember different partitions h$
...
#SBATCH --output=20231018_test_as.log ## standard out and standard error goes to this file
...
--simulate_reps 2 \
--out 20231027_all_mappings_test_1 -resume